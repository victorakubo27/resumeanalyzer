...
const Upload = () => {
    ...
    const handleAnalyze = async ({companyName,jobTitle,jobDescription,file}:{companyName:String,jobTitle:String,jobDescription:String,file:File})=>{
     ...
     data.feedback = JSON.parse(feedback.text);
     await kv.set(`resume:${uuid}`,JSON.stringify(data));
        ...
        <main className="bg-[url('/images/bg-main.svg')] bg-cover">
            ...
            <section className='main-section'>
                <div className='page-heading'>
                    ...
                    {!isProcessing && (
                        <form id='upload-form mt-8' className='flex flex-col gap-4' onSubmit={handleSubmit}>
                            <div className='form-div py-16'>
                                <label htmlFor='company-name'>Company Name</label>
                                <input type='text' name='company-name' placeholder='Company Name' id='company-name' />
                            </div>
                            <div className='form-div py-16'>
                                <label htmlFor='job-title'>Job Title</label>
                                <input type='text' name='job-title' placeholder='Job Tile' id='job-title' />
                            </div>
                            <div className='form-div py-16'>
